...
const ActionIcon = polymorphicFactory.polymorphicFactory((_props, ref) => {
  ...
  return /* @__PURE__ */ React__default.default.createElement(
    ...
    /* @__PURE__ */ React__default.default.createElement(Box.Box, { component: "span", ...getStyles("loader"), "aria-hidden": true }, /* @__PURE__ */ React__default.default.createElement(Loader.Loader, { color: "var(--ai-color)", size: "calc(var(--ai-size) * 0.55)", ...loaderProps })),
