...
const ModalBaseOverlay = React.forwardRef(
  ({ onClick, transitionProps, style, ...others }, ref) => {
    ...
    return /* @__PURE__ */ React__default.default.createElement(Transition.Transition, { mounted: ctx.opened, ...transition, transition: "fade" }, (transitionStyles) => /* @__PURE__ */ React__default.default.createElement(
      Overlay.Overlay,
      {
        ref,
        fixed: true,
