...
function PaginationIcon({ style, children, path, ...others }) {
  return /* @__PURE__ */ React__default.default.createElement(
    ...
    /* @__PURE__ */ React__default.default.createElement("path", { d: path, fill: "currentColor" })
  );
}
const PaginationNextIcon = (props) => /* @__PURE__ */ React__default.default.createElement(
  PaginationIcon,
  {
    ...props,
...
const PaginationPreviousIcon = (props) => /* @__PURE__ */ React__default.default.createElement(
  PaginationIcon,
  {
    ...props,
...
const PaginationFirstIcon = (props) => /* @__PURE__ */ React__default.default.createElement(
  PaginationIcon,
  {
    ...props,
...
const PaginationLastIcon = (props) => /* @__PURE__ */ React__default.default.createElement(
  PaginationIcon,
  {
    ...props,
...
const PaginationDotsIcon = (props) => /* @__PURE__ */ React__default.default.createElement(
  PaginationIcon,
  {
    ...props,
