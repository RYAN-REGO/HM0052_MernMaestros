...
const Select = factory.factory((_props, ref) => {
  ...
  return /* @__PURE__ */ React__default.default.createElement(React__default.default.Fragment, null, /* @__PURE__ */ React__default.default.createElement(
    ...
    /* @__PURE__ */ React__default.default.createElement(Combobox.Combobox.Target, { targetType: searchable ? "input" : "button" }, /* @__PURE__ */ React__default.default.createElement(
      InputBase.InputBase,
      {
        id: _id,
        ref,
