...
const InlineInput = React.forwardRef(
  ({
    ...
    return /* @__PURE__ */ React__default.default.createElement(
      ...
      /* @__PURE__ */ React__default.default.createElement("div", { ...getStyles("body") }, children, /* @__PURE__ */ React__default.default.createElement("div", { ...getStyles("labelWrapper"), "data-disabled": disabled || void 0 }, label && /* @__PURE__ */ React__default.default.createElement("label", { ...getStyles("label"), "data-disabled": disabled || void 0, htmlFor: id }, label), description && /* @__PURE__ */ React__default.default.createElement(Input.Input.Description, { size, __inheritStyles: false, ...getStyles("description") }, description), error && error !== "boolean" && /* @__PURE__ */ React__default.default.createElement(Input.Input.Error, { size, __inheritStyles: false, ...getStyles("error") }, error)))
    );
  }
);
