...
const ActionIcon = polymorphicFactory((_props, ref) => {
  ...
  return /* @__PURE__ */ React.createElement(
    ...
    /* @__PURE__ */ React.createElement(Box, { component: "span", ...getStyles("loader"), "aria-hidden": true }, /* @__PURE__ */ React.createElement(Loader, { color: "var(--ai-color)", size: "calc(var(--ai-size) * 0.55)", ...loaderProps })),
